// ===== Login Page =====
// Email + Password login form with validation and error messages.
...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // If backend is not connected, allow demo login
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-blue-50 px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 mt-2">Welcome back! Log in to your account.</p>
        </div>
